...
class MyOutOfOrderProcessor(BaseCPUProcessor):
    def __init__(self, width, rob_size, num_int_regs, num_fp_regs):
        ...
        :param rob_size: sets the number of entries in the reorder buffer
        :param num_int_regs: sets the size of the integer register file
        :param num_fp_regs: sets the size of the vector/floating point register file
        """
